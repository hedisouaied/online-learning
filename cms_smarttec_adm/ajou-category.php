<?php
$pagetitle = "Ajout Categorie E-learning";
...
if ($_POST) {
	...
	$req = "INSERT INTO `category`(`Name` , `icon` , `Description` , `Parent`) VALUES ('" . $name . "','" . $icon . "','" . $desc . "','" . $parent . "')";
    ...
    <strong>Well done!</strong> categorie à été ajouté avec succès!!!</div>";
	} else {
		$msg = "<div class='alert alert-danger alert-dismissible' role='alert'> 
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
    <strong>Oh snap!</strong> categorie non ajouté!!! 
</div>";
	}
}
?>
			...
			<div class="row small-spacing">
				<div class="col-xs-9">
					<div class="box-content card white">
						<h4 class="box-title">Ajouter categorie E-learning</h4>
						<!-- /.box-title -->
						<p><?php echo $msg; ?></p>
						<div class="card-content">
							<form method="POST" enctype="multipart/form-data">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Entrer le nom de categorie" required name="Name">
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Material Icons</label>
									<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Entrer le code de l'icone" required name="icon">
