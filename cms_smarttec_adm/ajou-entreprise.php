...
$req = "INSERT INTO `recent`(`img`, `title1`, `title2`) VALUES ('".$img."','".$title1."','".$title2."')";
 } else{
     //3- Préparation de la requete
$req = "INSERT INTO `recent`(`img`, `title1`, `title2`) VALUES ('".$img."','".$title1."','".$title2."')";
 }
					...
					<div class="card-content">
						<form method="POST"   enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter your email" name="title1">
                            </div>
                            <div class="form-group">
