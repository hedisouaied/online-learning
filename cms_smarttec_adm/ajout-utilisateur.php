...
if ($_POST) {
    ...
    $req = "INSERT INTO `clients` (`fullname`, `email`, `password`, `country`, `phone`, `genre`) VALUES ('" . $fullname . "','" . $email . "','" . $password . "','" . $country . "','" . $phone . "','" . $genre . "')";
    $exec = mysqli_query($conn, $req);

    if ($exec) {
        $msg = "<div class='alert alert-success alert-dismissible' role='alert'>
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
    <strong>Well done!</strong> Votre Utilisateur a été ajouté.
</div>";
    } else {
        $msg = "<div class='alert alert-danger alert-dismissible' role='alert'> 
    <button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
    <strong>Oh snap!</strong> Utilisateur non ajouté!!! 
</div>";
    }
}
            ...
            <div class="row small-spacing">
                <div class="col-xs-9">
                    <div class="box-content card white">
                        <h4 class="box-title">Ajout Utilisateur</h4>
                        <!-- /.box-title -->
                        <p><?php echo $msg; ?></p>
                        <div class="card-content">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" placeholder="Entrer Votre admin username" name="name" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="email_2" class="form-control form-control-prepended" name="dawla" onchange='x =this.options[this.selectedIndex].getAttribute("data-code"); var cpp = document.getElementById("ccp");cpp.value = x; '>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" class="form-control" placeholder="99 500 500" name="phone" required>
                                </div>
                                ...
                                <a href="users-list.php" class="btn btn-info btn-sm waves-effect waves-light">Retour</a>
                            </form>
                        </div>
                        <!-- /.card-content -->
                    </div>
