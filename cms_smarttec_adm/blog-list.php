...
if(isset($_GET['bl_id'])){
	$idb = $_GET['bl_id'];
	$req = "DELETE FROM `blog` WHERE ID=$idb ";
...
?>	
     ...
     ?>
								...
								<td><img style="width:190px;height:100px;" src="../uploads/img_blog/<?php echo $array['Image'] ; ?>" ></td>
                                <?php }
                                else{
								...
								<td><?php echo $array['Titre'] ; ?></td>
								<td><?php echo $array['Date'] ; ?></td>
								
								<td>
						            <a href="edit-blog.php?bl_id=<?php echo $array['ID']; ?>"><i style="color:#fff;background-color:#00aeff;" class="btn btn-rounded waves-effect waves-light fa fa-pencil" aria-hidden="true"></i></a>
	...
	<div class="remodal-content">
		...
		<p id="modal1Desc">
		Vous êtes sur de supprimer ce blog ?
		</p>
	</div>
	<button data-remodal-action="cancel" class="remodal-cancel">Annuler</button>
	<a href="?bl_id=<?php echo $array['ID']; ?>" class="btn btn-primary">Supprimer</a>
</div>
