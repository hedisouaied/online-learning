...
if (isset($_GET['aa'])) {
    ...
    header("location: list-orders-live.php");
}
        ...
        <div class="col-lg-12 col-xs-12">
            <div class="box-content">
                ...
                <select onchange="location = this.options[this.selectedIndex].value;" class="form-control">
                    <option value="list-orders-live.php">Tous</option>
                    <?php
                    ...
                    while ($array = mysqli_fetch_array($exec)) {
                        ...
                        echo "<option style='color:white;background:#00aeff;' disabled value='" . $array['ID_f'] . "' >" . $array['Name_f'] . "</option>";

                        $query1 = "SELECT * FROM `events` WHERE ID_f = " . $array['ID_f'];
                        ...
                        while ($array1 = mysqli_fetch_array($exec1)) {
                            ...
                            echo "<option ";
                            if (isset($_GET['id_filter'])) {
                                if ($_GET['id_filter'] == $array1['id']) {
                                    echo " selected ";
                                }
                            }
                            echo " value='?id_filter=" . $array1['id'] . "'>" . $array1['title'] . "</option>";
                        }
                    }
                ...
                <table class="table table-striped margin-bottom-10 table-purchases">
                    ...
                    <tbody>
                        ...
                        $filtre = '';
                        if (isset($_GET['id_filter'])) {
                            $filtre = "AND ID_p = " . $_GET['id_filter'];
                        }
                        $query = "SELECT * FROM `checkout`  WHERE type_p = 'Direct' " . $filtre." ORDER BY ID DESC";
                        ...
                        ?>
                            <tr>
                                ...
                                <?php if ($array['Paid'] == 1) {
                                    ...
                                    echo '<td><a  class="text-warning confirm" href="list-orders-live.php?id=' . $array['ID'] . '&aa=1">En attente</a></td>';
