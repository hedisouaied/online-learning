            ...
            <div class="col-xs-12">
                <div class="box-content">
                    <table id="example-edit" class="display" style="width: 100%">
                        ...
                        <tbody>
                            <?php
                            $query = "SELECT * FROM `certificate` WHERE Type = 'E-learning'";
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php $req_cour = "SELECT * FROM cours WHERE ID_c = " . $array['ID_cours'] . " ";
                                        $exec_cour = mysqli_query($conn, $req_cour);
                                        $array_cour = mysqli_fetch_array($exec_cour);
                                        echo $array_cour['Name_c'] ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="downloadcertif.php?code=<?php echo $array['code_certif']; ?>&user=<?php echo $array_user['ID'] ?>&cours=<?php echo $array_cour['ID_c']; ?>&pdf=<?php echo $array['PDF']; ?>" class="btn btn-rounded btn-info waves-effect waves-light"><i class="fa fa-download"></i></a>
                                ...
                                <div class="modal fade" id="example<?php echo $array['ID']; ?>Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div style="margin: 7rem auto;" class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <img src="../test_certif/certificate/<?php echo $array['code_certif'] . $array['ID_sess'] . $array['ID_cours'] . '.jpg' ?>" alt="" />
