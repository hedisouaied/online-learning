...
if ($_POST) {
    ...
    $quiz_id = mysqli_real_escape_string($conn, $id_c);
    $question =  mysqli_real_escape_string($conn, $_POST['question']);
    $points =  mysqli_real_escape_string($conn, $_POST['points']);


    $query1 = "SELECT * FROM `questions-live` where ID=$id_c ";
    ...
    $req_quiz = "UPDATE `questions-live` SET `question`='" . $question . "',`Image`='" . $logo . "',`points`='" . $points . "' WHERE ID=" . $_GET['quiz_id'] . " ";
    ...
    for ($j = 0; $j < $i; $j++) {
        ...
        $req = "UPDATE `reponse-live` SET `reponse`='" . $rr . "',`vrai_faux`='" . $vf . "' WHERE ID= " .  $id_rr . " ";
    ...
    if (isset($_POST['reponse'])) {
        ...
        for ($j = 0; $j < $i; $j++) {
            ...
            $req = "INSERT INTO `reponse-live` (`question_id`, `reponse`, `vrai_faux`) VALUES('" . $_GET['quiz_id'] . "','" . $rr . "','" . $vf . "')";
...
if (isset($_GET['supp_id'])) {
    $idsec = $_GET['supp_id'];
    $req = "DELETE FROM `reponse-live` WHERE ID=$idsec ";
    $exec = mysqli_query($conn, $req);
}
?>
                    ...
                    <div class="box-content card white">
                        ...
                        <div class="card-content">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                $query3 = "SELECT * FROM `questions-live` where ID = " . $_GET['quiz_id'] . " ";
                                ...
                                <div class="row">
                                    <?php
                                    $req_rep = "SELECT * FROM `reponse-live` WHERE question_id = " . $_GET['quiz_id'] . " ";
                                ...
                                <a type="submit" class="btn btn-info btn-sm waves-effect waves-light" href="ajou-quiz-live.php?cours_id=<?php echo $_GET['cours_id']; ?>">Retour</a>
                            </form>
                        </div>
                    </div>
                </div>
